...
Identity Locker is a simple, runnable prototype demonstrating how users can create self-owned decentralized identities (DIDs), receive verifiable credentials (e.g., email verification, age claim), present selective proofs to verifiers, and support revocation—all backed by a Polkadot anchoring mechanism.
...
Open UI → Create Holder DID
Create Issuer DID
Click “Issue VC” → You should see a VC ID
STEP 2 — Verify

Click “Verify Presentation” → Expect: \"verified\": true
STEP 3 — Revoke & Re-Verify

Click “Revoke VC”
Click “Verify Presentation” → Expect: \"verified\": false
